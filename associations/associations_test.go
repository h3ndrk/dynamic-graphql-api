			...
			Object{
				...
				Fields: []Field{
					...
					Field{
						...
						JoinForeignField: func() *string { s := "h_id"; return &s }(),
						JoinOwnField:     func() *string { s := "g_id"; return &s }(),
					},
				},
			},
			Object{
				...
				Fields: []Field{
					...
					Field{
						...
						JoinTable:        func() *string { s := "g_h"; return &s }(),
						JoinForeignField: func() *string { s := "g_id"; return &s }(),
						JoinOwnField:     func() *string { s := "h_id"; return &s }(),
					},
				},
			},
		},
